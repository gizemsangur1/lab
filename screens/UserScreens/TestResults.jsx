		...
		const userTestResults=async()=>{
			try {
				  ...
				  const filtered = enrichedPatients.filter(
					(patient) =>
					  (patient.patientName && user.name && patient.patientName.toLowerCase().includes(user.name.toLowerCase())) ||
					  (patient.patientSurname && user.surname && patient.patientSurname.toLowerCase().includes(user.surname.toLowerCase()))
				  );
